...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ArtistViewHolder>{
    ...
    public void onBindViewHolder(ArtistViewHolder holder, int position) {
        ...
        //RoundedBitmapDrawable imageRound = UtilsImages.roundImages(holder.imgArtist,R.drawable.artist);

        holder.imgArtist.setImageResource(R.drawable.artist);
        holder.imgArtist.setBackgroundColor(UtilsImages.colorAlea());

        holder.txvArtistName.setText(artists.get(position).getArtistName());
        holder.txvArtistName.setSelected(true);
    }
