...
public class ContextMenuRecycler extends RecyclerView {

    private ContextMenu.ContextMenuInfo mContextMenuInfo;

    public ContextMenuRecycler(Context context) {
        super(context);
    }

    public ContextMenuRecycler(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ContextMenuRecycler(Context context, AttributeSet attrs, int defStyle) {
